...
with open("incorrect_scores","r") as incr, open("incorrect_scores.norm","w") as incw, open("correct_scores","r") as cr, open("correct_scores.norm","w") as cw, open("disambig.cs.europarl.incorrect","r") as inclines, open("disambig.cs.europarl.correct","r") as clines:
