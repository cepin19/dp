...
$marian_home/marian \
    --model model/model.src1tgt0.doc_voita.npz  --type transformer \
    --train-sets corp/europarl.cs-en.docs.train.en.bpe.src corp/europarl.cs-en.docs.train.cz.bpe  \
    ...
    --early-stopping 10 \
    --valid-freq 5000 --save-freq 1000 --disp-freq 1000 \
    --valid-metrics cross-entropy perplexity translation \
    --valid-sets corp/europarl.cs-en.docs.dev.en.bpe.src corp/europarl.cs-en.docs.dev.cz.bpe \
