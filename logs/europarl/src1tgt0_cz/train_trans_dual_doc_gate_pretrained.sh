marian_home=/mnt/minerva1/nlp/projects/nmt/marian-doc-gated4/doc-marian/build
export ENABLE_CUBLAS_TENSOR_OP_MATH_FP32=0
$marian_home/marian \
    --model model/model.src1tgt0.dual.doc.same_embedding.gate_really.notc.pretrained.len80.npz --pretrained-model ../src0tgt0/model.src0tgt0.trans3.iter110000.npz --type transformer-context \
