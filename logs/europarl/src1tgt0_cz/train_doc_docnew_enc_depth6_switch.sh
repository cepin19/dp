...
marian_home=/mnt/minerva1/nlp/projects/nmt/doc-marian3/build
$marian_home/marian \
    --model model/model.src1tgt0.from_new_pretrained.context-enc-depth6.newest.switch.npz --pretrained-model model/model.src1tgt0.docnew.enc_depth.test_base.npz.best-perplexity.npz  --type transformer-context \
    --train-sets corp/europarl.cs-en.docs.train.en.bpe.src corp/europarl.cs-en.docs.train.en.bpe.src_prev corp/europarl.cs-en.docs.train.cz.bpe  \
    ...
    --early-stopping 10 --context-enc-depth 6 \
    --valid-freq 5000 --save-freq 5000 --disp-freq 1000 \
    --valid-metrics cross-entropy perplexity translation \
    --valid-sets corp/europarl.cs-en.docs.dev.en.bpe.src corp/europarl.cs-en.docs.dev.en.bpe.src_prev corp/europarl.cs-en.docs.dev.cz.bpe \
