marian_home=/mnt/minerva1/nlp/projects/nmt/4/marian-dev/build
# turn off tensorcores 
export ENABLE_CUBLAS_TENSOR_OP_MATH_FP32=0
$marian_home/marian \
    --model model/model.src1tgt0.dual.notc.len80.npz --type multi-transformer \
    ...
    --log model/train_trans.dual.notc.log --valid-log model/valid_trans.dual.notc.log \
