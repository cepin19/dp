...
$marian/marian-decoder  -d 0  -n $1 -b 6 -v corp/vocab.encs.europarl.yml corp/vocab.encs.europarl.yml  -m  model/model.src1tgt0.concat.npz --mini-batch 16 -i corp/europarl.cs-en.docs.dev.en.bpe  > out_test
