...
$marian_home/marian \
    --model model/model.src1tgt0.docnew.enc_depth.pretrained.frozen.npz  --pretrained-model ../src0tgt0/model/model.src0tgt0_to_tgt0.newbase.160.npz.best-perplexity.npz --type transformer-context \
