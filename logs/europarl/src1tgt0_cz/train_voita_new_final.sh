...
marian_home=/mnt/minerva1/nlp/projects/nmt/doc-marian-voita/doc-marian3/build
$marian_home/marian \
    --model model/model.src1tgt0.voita.new.final.npz  --type transformer-voita \
    ...
    --mini-batch-fit -w 8800  --mini-batch 1000 --maxi-batch 1000 \
    --early-stopping 10  \
