...
marian_home=/mnt/minerva1/nlp/projects/nmt/doc-marian-new2/doc-marian/build
$marian_home/marian \
    --model model/model.src1tgt0.from_new_pretrained.context-enc-depth1.last2.npz --pretrained-model model/model.src1tgt0.docnew.enc_depth.test_base.npz.best-perplexity.npz  --type transformer-context \
    ...
    --early-stopping 10 --freeze --context-enc-depth 1 \
