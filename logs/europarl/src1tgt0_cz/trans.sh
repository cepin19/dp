...
$marian/marian-decoder  -d 0  -n $1 -b 6 -v corp/vocab.encs.europarl.yml corp/vocab.encs.europarl.yml corp/vocab.encs.europarl.yml -m  model/model.src1tgt0.dual.notc.len80.npz --mini-batch 16 -i corp/europarl.cs-en.docs.dev.en.bpe.src_prev corp/europarl.cs-en.docs.dev.en.bpe.src > out_test
