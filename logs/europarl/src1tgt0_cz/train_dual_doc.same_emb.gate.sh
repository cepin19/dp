...
marian_home=/home/large/data/models/marian/marian-doc/same_emb_no_transpose_gate_run2/build
$marian_home/marian \
    --model model/model.src1tgt0.doc.gate.same_emb2.opt_delay4.npz --type transformer-context \
    ...
    --mini-batch-fit -w 9200  --mini-batch 1000 --maxi-batch 1000 \
    --early-stopping 10 \
