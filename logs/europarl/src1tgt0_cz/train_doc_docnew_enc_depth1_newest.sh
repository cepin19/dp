...
$marian_home/marian \
    --model model/model.src1tgt0.from_new_pretrained.context-enc-depth6.newest.nogate.npz --pretrained-model model/model.src1tgt0.docnew.enc_depth.test_base.npz.best-perplexity.npz  --type transformer-context \
