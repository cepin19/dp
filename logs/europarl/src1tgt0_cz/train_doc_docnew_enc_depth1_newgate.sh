...
$marian_home/marian \
    --model model/model.src1tgt0.from_new_pretrained.context-enc-depth1.newest.newgate.npz --pretrained-model model/model.src1tgt0.docnew.enc_depth.test_base.npz.best-perplexity.npz  --type transformer-context \
    ...
    --early-stopping 10 --freeze --context-enc-depth 1 --context-gate \
