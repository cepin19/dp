marian_home=/mnt/minerva1/nlp/projects/nmt/marian-doc/marian-dev/build
export ENABLE_CUBLAS_TENSOR_OP_MATH_FP32=0
$marian_home/marian \
    --model model/model.src1tgt0.dual.doc.same_embedding.gate.notc.len80.npz --type transformer-context \
