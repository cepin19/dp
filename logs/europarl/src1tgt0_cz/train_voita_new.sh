...
$marian_home/marian \
    --model model/model.src1tgt0.voita.new.npz --pretrained-model model/model.src1tgt0.docnew.enc_depth.test_base.npz.best-perplexity.npz  --type transformer-voita \
