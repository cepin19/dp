marian_home=/home/big_maggie/usr/marian_prometheus/marian_1.7.3/marian-dev/build
#marian_home=/home/big_maggie/usr/marian_cosmas/marian_1.7.3/marian-dev/build
$marian_home/marian \
    --model model/model.src0tgt0.npz --type transformer \
    ...
    --mini-batch-fit -w 9400 --maxi-batch 1000 \
    --early-stopping 10 \
    ...
    --devices 1 2 --sync-sgd --seed 1111 \
