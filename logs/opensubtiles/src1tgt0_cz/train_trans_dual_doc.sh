...
$marian_home/marian \
    --model model/model.src1tgt0.dual.doc.same_emb2.npz --pretrained-model model/model.src1tgt0.dual.doc.same_emb.npz --type transformer-context \
    --train-sets corp/opensub.cs-en.docs.train.en.bpe.src_prev corp/opensub.cs-en.docs.train.en.bpe.src corp/opensub.cs-en.docs.train.fr.bpe  \
    ...
    --valid-sets corp/opensub.cs-en.docs.dev.en.bpe.src_prev corp/opensub.cs-en.docs.dev.en.bpe.src corp/opensub.cs-en.docs.dev.fr.bpe \
    --valid-script-path ./val.sh \
    --valid-translation-output data/valid.bpe.en.output --quiet-translation \
    --valid-mini-batch 64 \
    --beam-size 6 --normalize 0.6 \
    --log model/train_trans.newvocab.log --valid-log model/valid_trans.newvocab.log \
