...
marian_home=/home/large/data/models/marian/marian-doc/marian_voita/doc-marian/build
$marian_home/marian \
    --model model/model.voita.sanity.npz --pretrained-model ../src0tgt0_fr/model/model.src0tgt0.newvocab.iter630000.npz  --type transformer-context \
    --train-sets corp/opensub.en-fr.docs.train.fr.bpe corp/opensub.en-fr.docs.train.en.bpe.src corp/opensub.en-fr.docs.train.fr.bpe  \
    ...
    --mini-batch-fit -w 9300  --mini-batch 1000 --maxi-batch 1000 \
    --early-stopping 10 \
    --valid-freq 5000 --save-freq 5000 --disp-freq 500 \
    --valid-metrics cross-entropy perplexity translation \
    --valid-sets corp/opensub.en-fr.docs.dev.fr.bpe corp/opensub.en-fr.docs.dev.en.bpe.src corp/opensub.en-fr.docs.dev.fr.bpe \
    --valid-script-path ./val.sh \
    --valid-translation-output data/valid.bpe.en.output --quiet-translation \
    --valid-mini-batch 64 \
    --beam-size 6 --normalize 0.6 \
    --log model/train_trans.gate.log --valid-log model/valid_trans.gate.log \
    --enc-depth 6 --dec-depth 6 --context-enc-depth 4 \
    --transformer-heads 8 \
