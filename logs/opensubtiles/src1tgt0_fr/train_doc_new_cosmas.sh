...
marian_home=/home/large/data/models/marian/marian-doc/marian-doc-laynorm-cosmas/doc-marian/build
$marian_home/marian \
    --model model/model.src1tgt0.doc.new.cosmas.npz --pretrained-model ../src0tgt0_fr/model/model.src0tgt0.newvocab.iter630000.npz  --type transformer-context \
    ...
    --devices 2 3 --sync-sgd --seed 1111 \
