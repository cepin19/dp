...
marian_home=/home/large/data/models/marian/marian-doc/doc-marian3/build
$marian_home/marian \
    --model model/model.src1tgt0.doc.new.bakchus.newest.npz --pretrained-model ../src0tgt0_fr/model/model.src0tgt0.newvocab.iter630000.npz  --type transformer-context \
