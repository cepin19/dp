...
echo "CONCAT"
$marian/marian-decoder  -d $dev  -n $n -b 6 -v $vocab $vocab $vocab  -m  $concat_model --mini-batch 8 -i corp/opensub.en-fr.docs.test.en.bpe.src_prev  corp/opensub.en-fr.docs.test.en.bpe.src  > out_test
