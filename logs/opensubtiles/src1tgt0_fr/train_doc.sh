...
$marian_home/marian \
    --model model/model.src1tgt0.doc.pretrained.npz --pretrained-model ../src0tgt0_fr/model/model.src0tgt0.newvocab.iter195000.npz  --type transformer-context \
    ...
    --mini-batch-fit -w 8400  --mini-batch 1000 --maxi-batch 1000 \
    --early-stopping 10 \
