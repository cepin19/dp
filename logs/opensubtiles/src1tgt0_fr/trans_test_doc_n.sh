...
$marian/marian-decoder  -d $dev  -n $n -b 6 -v $vocab $vocab  $vocab -m  $model --mini-batch 64 -i corp/opensub.en-fr.docs.dev.en.bpe.src_prev corp/opensub.en-fr.docs.dev.en.bpe.src > out_test_$sys_name
