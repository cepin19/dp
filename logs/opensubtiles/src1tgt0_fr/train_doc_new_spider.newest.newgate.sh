...
marian_home=/home/large/data/models/marian/marian-doc/doc-marian3_metis/build
$marian_home/marian \
    --model model/model.src1tgt0.doc.new.spider.newgate.npz --pretrained-model ../src0tgt0_fr/model/model.src0tgt0.newvocab.iter630000.npz  --type transformer-context \
    ...
    --max-length 55 --dim-vocabs 30000 30000 --context-gate --freeze --embedding-fix-src --embedding-fix-trg \
