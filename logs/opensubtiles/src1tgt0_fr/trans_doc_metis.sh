dev=0
marian=/home/big_maggie/usr/marian_metis/marian_1.7.8/marian-dev/build
...
marian=/home/large/data/models/marian/marian-doc/doc-marian3_metis_prev_gate/build
...
concat_model=model/model.src1tgt0.doc.new.spider.newgate.iter25000.npz
concat_model=model/model.src1tgt0.doc.new.spider.prevgate.npz
...
echo "CONCAT"
$marian/marian-decoder --context-gate  -d $dev  -n $n -b 6 -v $vocab $vocab $vocab  -m  $concat_model --mini-batch 16 -i corp/opensub.en-fr.docs.dev.en.bpe.src_prev corp/opensub.en-fr.docs.dev.en.bpe.src  > out_test
