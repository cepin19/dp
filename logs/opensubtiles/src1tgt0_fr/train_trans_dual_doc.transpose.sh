...
$marian_home/marian \
    --model model/model.src1tgt0.dual.doc.same_emb.transpose.npz --type transformer-context \
    ...
    --log model/train_trans.transpose.log --valid-log model/valid_trans.transpose.log \
    ...
    --devices 1  --sync-sgd --seed 1111 --no-nccl \
