...
marian=/home/large/data/models/marian/marian-doc/doc-marian3_metis_prev_gate_voita/build/
model=model/model.src1tgt0.voita.fix.tok.npz
sys_name=doc_rand
...
$marian/marian-decoder  -d $dev  -n $n -b 6 -v $vocab $vocab  $vocab -m  $model --mini-batch 8 -i corp/opensub.en-fr.docs.dev.en.bpe.src_prev corp/opensub.en-fr.docs.dev.en.bpe.src > out_test_$sys_name
