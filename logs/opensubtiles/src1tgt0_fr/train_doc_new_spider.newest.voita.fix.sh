...
marian_home=/home/large/data/models/marian/marian-doc/doc-marian3_metis_prev_gate_voita/build
$marian_home/marian \
    --model model/model.src1tgt0.voita.fix.tok.npz --pretrained-model ../src0tgt0_fr/model/model.src0tgt0.newvocab.iter630000.npz  --type transformer-voita \
    --train-sets corp/opensub.en-fr.docs.train.en.bpe.src_prev_tok corp/opensub.en-fr.docs.train.en.bpe.src corp/opensub.en-fr.docs.train.fr.bpe  \
    ...
    --mini-batch-fit -w 8200  --mini-batch 1000 --maxi-batch 1000 \
    --early-stopping 10 \
    --valid-freq 5000 --save-freq 5000 --disp-freq 500 \
    --valid-metrics cross-entropy perplexity translation \
    --valid-sets corp/opensub.en-fr.docs.dev.en.bpe.src_prev_tok corp/opensub.en-fr.docs.dev.en.bpe.src corp/opensub.en-fr.docs.dev.fr.bpe \
