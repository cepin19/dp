...
$marian_home/marian \
    --model model/model.src1tgt0.voita.last.switch.npz --pretrained-model ../src0tgt0_fr/model/model.src0tgt0.newvocab.iter630000.npz  --type transformer-voita \
    --train-sets corp/opensub.en-fr.docs.train.en.bpe.src corp/opensub.en-fr.docs.train.en.bpe.src_prev corp/opensub.en-fr.docs.train.fr.bpe  \
    ...
    --valid-sets corp/opensub.en-fr.docs.dev.en.bpe.src corp/opensub.en-fr.docs.dev.en.bpe.src_prev corp/opensub.en-fr.docs.dev.fr.bpe \
