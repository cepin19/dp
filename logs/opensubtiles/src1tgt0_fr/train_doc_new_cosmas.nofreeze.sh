...
$marian_home/marian \
    --model model/model.src1tgt0.doc.new.cosmas.nofreeze.npz --pretrained-model ../src0tgt0_fr/model/model.src0tgt0.newvocab.iter630000.npz  --type transformer-context \
